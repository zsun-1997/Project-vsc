...
export class InitialMigration1641677200652 implements MigrationInterface {
    async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.createForeignKey("orderItem", new TableForeignKey({
    ...
    async down(queryRunner: QueryRunner): Promise<void> {
        ...
        const foreignKey1 = table1.foreignKeys.find(fk => fk.columnNames.indexOf("productId") !== -1);
        await queryRunner.dropForeignKey("orderItem", foreignKey1);
        const table2 = await queryRunner.getTable("orderItem");
        const foreignKey2 = table2.foreignKeys.find(fk => fk.columnNames.indexOf("orderId") !== -1);
